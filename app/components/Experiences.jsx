  ...
  return (
    ...
    >
      <motion.h4
        ...
        custom={1}
      >
        Work, Organizational & Committee Experiences⌛
      </motion.h4>
      <motion.h2
      ...
      <div className="max-w-7xl mx-auto max-h-10/12">
        <div className="relative group rounded-full">
              ...
              {experienceData && experienceData.length > 0 ? (
                experienceData.map((experience, idx) => (
                  <SwiperSlide key={experience.id} className="max-w-xs md:max-w-md lg:max-w-xl">
                    <motion.div
                      className="rounded-2xl shadow-xl overflow-hidden transition-all duration-500 hover:shadow-2xl bg-white group-hover:scale-95 hover:scale-110 hover:!opacity-100"
                      variants={fadeUp}
                      custom={4 + idx}
                      initial="hidden"
                      whileInView="visible"
                    ...
                    >
                      ...
                      <div className="p-6">
                        ...
                        <ul className="mt-4 space-y-2">
                          {experience.description.map((item, idx2) => (
                            <li key={idx2} className="text-gray-600 text-sm flex items-start">
          ...
          <motion.div
            ...
            variants={fadeUp}
            custom={experienceData?.length ? 4 + experienceData.length : 5}
          >
